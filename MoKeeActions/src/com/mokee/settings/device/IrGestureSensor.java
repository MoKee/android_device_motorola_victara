...
import static com.mokee.settings.device.IrGestureManager.*;

public class IrGestureSensor implements ScreenStateNotifier, SensorEventListener {
    private static final String TAG = "MoKeeActions-IRGestureSensor";
    ...
    public IrGestureSensor(MoKeeActionsSettings cmActionsSettings, SensorHelper sensorHelper,
    ...
    public void screenTurnedOff() {
        if (mMoKeeActionsSettings.isIrWakeupEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
