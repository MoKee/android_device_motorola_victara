...
public class UserAwareDisplay implements ScreenStateNotifier {
    private static final String TAG = "MoKeeActions-UAD";
    ...
    public UserAwareDisplay(MoKeeActionsSettings cmActionsSettings, SensorHelper sensorHelper,
    ...
    public void screenTurnedOn() {
        if (mMoKeeActionsSettings.isUserAwareDisplayEnabled()) {
