...
public class IrSilencer extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "MoKeeActions-IRSilencer";
    ...
    public IrSilencer(MoKeeActionsSettings cmActionsSettings, Context context,
    ...
    public void updateState() {
        if (mMoKeeActionsSettings.isIrSilencerEnabled()) {
